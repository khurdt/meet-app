 ...
 * for now because you don't have access rights to update the calendar yourself.
 * For more info, check out the SCOPES documentation at 
...
const credentials = {
  ...
  redirect_uris: ['https://khurdt.github.io/meet-app'],
  javascript_origins: ["https://khurdt.github.io", "http://localhost:3000"],
};
...
module.exports.getAuthURL = async () => {
   ...
   * Google Console. Also, any passed scopes are the ones users will see 
